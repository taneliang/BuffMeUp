  ...
  <div id="about">
    ...
    <h3>How does it work?</h3>
      <p>If someone finds their buffet has way too much leftover food for them
        ...
        Once a buffet has been vanquished, a user will be able to celebrate the
        victory by deleting the post so that the world may know of their great
        accomplishment!<br>
        (So other brave buffet helpers don't end up visiting an empty buffet)<br>
        </p> <br>
  </div>
</template>
